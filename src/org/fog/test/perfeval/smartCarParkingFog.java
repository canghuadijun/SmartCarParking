...
public class smartCarParkingFog {
    ...
    static int numOfAreas = 4;  // số fog node
    static int numOfCamerasPerArea1 = 4;  // số camera trên từng khu vực
    static double CAM_TRANSMISSION_TIME = 5; // Thời gian truyền thông của camera
    private static boolean CLOUD = false;  // giá trị false là chạy mô hình fog, true là chạy mô hình cloud
    ...
    /**
     * Tạo các fog devices, bao gồm Cloud và Proxy Server, và thêm chúng vào danh sách
     * Gọi hàm addArea để thêm các khu vực vào hệ thống.
     */
    ...
    /**
     * Tạo router cho từng khu vực và thêm chúng vào danh sách fogDevices.
     * Gọi hàm addCamera để thêm các smart camera vào khu vực.
     */
    ...
    /**
     * Tạo fog device đại diện cho smart camera và thêm vào danh sách fogDevices.
     * Tạo sensor và actuator tương ứng cho camera và thêm vào danh sách sensors và actuators.
     */
    ...
    /**
     * Tạo và cấu hình một fog device với các thông số như MIPS, RAM, băng thông, và chi phí.
     * Mô phỏng một host có một loạt các PE (Processing Elements).
     */
    ...
    /**
     * Tạo ứng dụng với hai module là "picture-capture" và "slot-detector".
     * Thiết lập các kết nối giữa các module trong đồ thị ứng dụng và ánh xạ tuple giữa các module.
     */
